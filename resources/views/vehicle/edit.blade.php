        ...
        <div class="col-md-12">
            ...
            <form method="post" action="{{ action('App\Http\Controllers\VehicleController@update', $id) }}">
                ...
                <div class="form-group">
                    <input type="text" name="regNo" class="form-control" value="{{ $vehicle->regNo }}"
                ...
                <div class="form-group">
                    <input type="text" name="mYear" class="form-control" value="{{ $vehicle->mYear }}"
                        placeholder="Enter Model Year" />
                </div>
                <div class="form-group">
                    <input type="text" name="rYear" class="form-control" value="{{ $vehicle->rYear }}"
                        placeholder="Enter Registered Year" />
                </div>
                <div class="form-group">
                    <input type="text" name="service" class="form-control" value="{{ $vehicle->service }}"
                        placeholder="Enter Service" />
                </div>
                <div class="form-group">
                    <input type="text" name="cost" class="form-control" value="{{ $vehicle->cost }}"
